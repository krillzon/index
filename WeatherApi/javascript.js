...
.then(function(data)
{
        ...
        krippa.innerHTML += `In ${name.name} it is ${weather.main}.<br>`;
        ...
        krippa.innerHTML += `Live Temperature: ${temp.temp -273,15}° <br>`
        krippa.innerHTML += `(Max temp: ${temp.temp_max -273,15}° , min temp: ${temp.temp_min - 273,15}° )<br>`;
